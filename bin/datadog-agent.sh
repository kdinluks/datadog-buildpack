...
. $APP_ROOT/lib/lsb/init-functions
PATH=$PATH:/sbin # add the location of start-stop-daemon on Debian

AGENTPATH="$APP_ROOT/opt/datadog-agent/agent/agent.py"
AGENTCONF="$APP_ROOT/etc/dd-agent/datadog.conf"
DOGSTATSDPATH="$APP_ROOT/opt/datadog-agent/agent/dogstatsd.py"
KILL_PATH="$APP_ROOT/opt/datadog-agent/embedded/bin/kill"
AGENTUSER="dd-agent"
FORWARDERPATH="$APP_ROOT/opt/datadog-agent/agent/ddagent.py"
NAME="datadog-agent"
DESC="Datadog Agent"
SUPERVISOR_PIDFILE="$APP_ROOT/opt/datadog-agent/run/datadog-supervisord.pid"
SUPERVISOR_FILE="$APP_ROOT/etc/dd-agent/supervisor.conf"
SUPERVISOR_SOCK="$APP_ROOT/opt/datadog-agent/run/datadog-supervisor.sock"
SUPERVISORCTL_PATH="$APP_ROOT/opt/datadog-agent/bin/supervisorctl"
SUPERVISORD_PATH="$APP_ROOT/opt/datadog-agent/bin/supervisord"
COLLECTOR_PIDFILE="$APP_ROOT/opt/datadog-agent/run/dd-agent.pid"
SYSTEM_PATH=$APP_ROOT/opt/datadog-agent/embedded/bin:$APP_ROOT/opt/datadog-agent/bin:$PATH
